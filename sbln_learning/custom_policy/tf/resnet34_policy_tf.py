...
class Resnet34_policy(ActorCriticPolicy):
    def __init__(self, sess, ob_space, ac_space, n_env, n_steps, n_batch, reuse=False, **kwargs):
        super(Resnet34_policy, self).__init__(sess, ob_space, ac_space, n_env, n_steps, n_batch, reuse=reuse, scale=True)
        ...
        with tf.variable_scope("model", reuse=reuse):
            ...
            # 34层卷积
            resNet_34 = make_layers(conv0, resblock, block_num=17, kernel_num=128, layer_name="basic_block")

            # 最后actor网络输出
            bn_actor = batch_norm(resNet_34, scope="bn_actor")
            ...
            # 最后value值网络的输出
            bn_value = batch_norm(resNet_34, scope="bn_value")
