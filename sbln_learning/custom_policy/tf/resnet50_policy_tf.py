...
class Resnet50_policy(ActorCriticPolicy):
    def __init__(self, sess, ob_space, ac_space, n_env, n_steps, n_batch, reuse=False, **kwargs):
        ...
        with tf.variable_scope("model", reuse=reuse):
            ...
            # 50层卷积
            resNet_50 = make_layers(conv0, resblock, block_num=25, kernel_num=128, layer_name="basic_block")

            # 最后actor网络输出
            bn_actor = batch_norm(resNet_50, scope="bn_actor")
            ...
            # 最后value值网络的输出
            bn_value = batch_norm(resNet_50, scope="bn_value")
