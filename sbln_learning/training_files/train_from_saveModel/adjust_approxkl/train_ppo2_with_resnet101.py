...
DynAppkl = "_dynAppkl_5"  #   _dynAppkl_0.5 是否动态调整kl散度
...
TENSORBOARD_LOG_NAME = "PPO2_fea848_"+DATACLIP+"lr_start"+str(INIT_LR)+"end"+str(END_LR)+"_"+POLICY+"_gm"+str(GAMMA)+"_clip"+str(INIT_CLIPRANGE)+"_entCoef"+\
                       str(ENT_COEF)+"_sqrtR_3pRawEP1.33_mid"+str(MidReward) + DynEnt
...
MODEL_PATH = "../save_model/ppo2_policy_scResnet101_tf_Nfea848_updateStep2048_lr0.002952666624_gamma0.925_entCoef0.0005_vfCoef0.5_reward1.3325372417266035_GangIsTrue_MidReward0.01_illegaA-8_abort_reward0_nsteps_17551363pRandom" # 从哪个模型开始恢复训练
# 从哪个模型开始恢复训练
...
INFO_ON_LOG = {"lr": INIT_LR, "lr_info": "LinearSchedule; end_lr:"+str(END_LR),"n_fea": 848,
               ...
               "GameInfo": {"opponent": ["rawEP1.33", "rawEP1.33", "rawEP1.33"], "midReward": MidReward, "sqrtReward": True,
