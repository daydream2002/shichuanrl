...
DynEnt = "_dynEnt_0.002"    # _dynEnt_0.5"  # 是否动态调节策略熵  数字必须放到后面，并且用_隔开
DynAppkl = "_dynAppkl_3"  # 是否动态调整kl散度
...
SAVEMODEL_REWARD = 0.5  # 从多少reward开始保存模型
...
MODEL_PATH = "./save_model/ppo2_scResnet101_tf_Nfea848_updateStep2048_lr0.0029329720145408003_gamma0.925_entCoef0.0005038621917833098_vfCoef0.5_reward0.9362075205586137_GangIsTrue_MidReward0.01_illegaA-8_abort_reward0_opponentEP1.299_nsteps_354304" # 从哪个模型开始恢复训练
# 从哪个模型开始恢复训练
