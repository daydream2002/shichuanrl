...
NUMB = "B19_" # 编号
DynEnt = ""    # _dynEnt_0.5"  # 是否动态调节策略熵  数字必须放到后面，并且用_隔开
DynAppkl = ""  # 是否动态调整kl散度
...
# MODEL_PATH = "./save_model/B10_ppo2_scResnet101_tf_Nfea848_updateStep2048_lr0.0029353450660352_gamma0.925_entCoef0.0005008419313835436_vfCoef0.5_reward0.11652551731424975_GangIsTrue_MidReward0.01_illegaA-8_abort_reward0_opponentEP1.04_B9_nsteps_151552" # 从哪个模型开始恢复训练
...
# MODEL_PATH = "./save_model/C31_ppo2_scResnet101_tf_Nfea848_updateStep2048_lr0.00293462131456_gamma0.925_entCoef0.0005009508330834088_vfCoef0.5_reward0.08861030987301073_GangIsTrue_MidReward0.01_illegaA-8_abort_reward0_opponentEP0.117_B10_nsteps_16384" # 从哪个模型开始恢复训练
