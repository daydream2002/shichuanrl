...
POLICY = "Resnet18_tf_2pzhiyi1pv5"  # 使用的策略
...
INIT_LR = 3e-4
LEARNING_RATE = LinearSchedule(TOTAL_TIMESTEPS, initial_p=INIT_LR, final_p=INIT_LR/10).value  # (float or callable) The learning rate, it can be a function

TENSORBOARD_LOG_NAME = "PPO2_fea488"+"lr_"+str(INIT_LR)+"_"+POLICY+"_gm"+str(GAMMA)+"_clip"+str(INIT_CLIPRANGE)+"_entCoef"+\
                       str(ENT_COEF)+"_sqrtR"
...
INFO_ON_LOG = {"lr": INIT_LR, "lr_info": "LinearSchedule; end_lr:"+str(INIT_LR/10),"n_fea":488,
               ...
               "GameInfo": {"opponent": ["zhiyi", "zhiyi", "shangrao_v5"], "midReward": True, "sqrtReward": True,
