...
N_STEPS = 256  # (int) The number of steps to run for each environment per update # 每个minibatches的步数
NMINIBATCHES = N_STEPS // 32  # (int) Number of training minibatches per update. For recurrent policies,
...
TENSORBOARD_LOG_NAME = NUMB + "PPO2_fea852_" + DATACLIP + "lr_start" + str(INIT_LR) + "end" + str(
...
env = make_vec_env(mahEnv.MahEnv, 8)  # 多环境，但并不是多线程
